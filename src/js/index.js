...
//passo 1 - pegar os personagens no JS pra poder mostrar ou esconder ele
    ...
    botoes.forEach((botao, indice) => {
        //addEventListener - Aceita um argumento só, click(escutar) e a função seta que dispara uma ação.
        botao.addEventListener("click", () => { 
        //passo 3 (objetivo 1) - verificar se já existe um botão selecionado, se sim, devemos removera seleção dele 
        desselecionarBotao();

        //passo 2 (objetivo 1) - adicionar a classe "selecionado" no botão que o usuário clicou
        botao.classList.add("selecionado");

        //passo 3 (objetivo 2) - verificar se já exista um personagem selecionado, se sim, devemos remover a seleção dele
